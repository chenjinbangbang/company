...
router.post('/create',upload.array('files',5),(req,res) => {
  ...
  let sql = `insert into articles (title,uid,price,unit_square,unit_time,price_original,unit_square_original,unit_time_original,images,content,create_time,update_time) values 
